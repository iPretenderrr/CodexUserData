...
namespace CodexUserData
{
    internal sealed partial class DynamicIsland
    {
        ...
        private void DrawGlass(DrawingContext dc)
        {
            ...
            double press=(double)GetValue(PressProperty),wave=running?Math.Sin(phase*2*Math.PI)*.55*strength:0;
            ...
            {
                Color tint=completion?colors[colors.Length-1]:colors[Math.Min(1,colors.Length-1)];tint.A=(byte)((18+30*breath)*strength);innerBrush.GradientStops[0].Color=tint;
